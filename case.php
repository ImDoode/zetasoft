          ...
          <div class="case-info">
            ...
            <div class="case-info__logos">
              <div class="case-info__logos-list">
                ...
                <img src="./dist/i/atol_logo.png" alt="atol logo">
                <img src="./dist/i/panel-1c.svg" alt="online test amico">
              </div>
            </div>
            <div class="case-info__img">
              <img src="./dist/i/Online test-amico 1.svg" alt="online test amico">
            </div>
      ...
      <section class="section section--case-item">
        <div class="wrapper">
          ...
          <div class="text-wrapper">
            ...
            <img src="./dist/i/atol-diagram.svg" alt="atol diagram">
          </div>
          <div class="text-wrapper">
        ...
        <div class="wrapper">
          ...
          <div class="swiper swiper--screenshots" data-swiper-id="case-screenshots">
            <div class="screenshots swiper-wrapper">
              <a href="./dist/i/menyu-atol-onlain 1.jpg" target="_blank" class="swiper-slide screenshots__item">
                <img src="./dist/i/menyu-atol-onlain 1.jpg" alt="screenshot 1" class="screenshots__img">
              </a>
              <a href="./dist/i/menyu-atol-onlain 2.jpg" target="_blank" class="swiper-slide screenshots__item">
                <img src="./dist/i/menyu-atol-onlain 2.jpg" alt="screenshot 2" class="screenshots__img">
              </a>
              <a href="./dist/i/menyu-atol-onlain 3.jpg" target="_blank" class="swiper-slide screenshots__item">
                <img src="./dist/i/menyu-atol-onlain 3.jpg" alt="screenshot 3" class="screenshots__img">
              </a>
            </div>
        ...
        <div class="wrapper">
          ...
          <div class="swiper" data-swiper-id="cases">
            <div class="cases js-cases swiper-wrapper">
              ...
              <a href="./cases.html" class="swiper-slide cases__item panel panel--decoration-blue" data-case-category="blue">
                <div class="panel__head">
                <img src="./dist/i/panel-1c.svg" alt="zeta logo" class="case__image">
                </div>
                <div class="panel__content case">
