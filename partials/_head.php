<meta charset="UTF-8">
  ...
  <script defer src="./dist/i/dist/js/filler.class.js?cache=<?php echo date("Y-m-d")?>"></script>
  <script defer src="./dist/i/dist/js/main.js?cache=<?php echo date("Y-m-d")?>"></script>
  <script defer src="./dist/i/dist/js/swiper-bundle.min.js?cache=<?php echo date("Y-m-d")?>"></script>
