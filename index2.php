              ...
              <div class="wrapper">
                ...
                <div class="steps">
                  <div class="steps__item">
                    ...
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/037-data analysis.svg">
                  </div>
                  <div class="steps__item">
                    ...
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/022-iteration.svg">
                  </div>
                  <div class="steps__item">
                    ...
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/006-confirmation.svg">
                  </div>
                  <div class="steps__item">
                    <div class="steps__item-number">4</div>
                    <div class="steps__item-text">Формируем бюджет решения и&nbsp;передаём в&nbsp;разработку</div>
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/011-calculator.svg">
                  </div>
                  <div class="steps__item">
                    <div class="steps__item-number">5</div>
                    <div class="steps__item-text">Наши разработчики пишут профессиональный&nbsp;код</div>
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/031-statistics.svg">
                  </div>
                  <div class="steps__item">
                    <div class="steps__item-number">6</div>
                    <div class="steps__item-text">Внедряем результат совместно с&nbsp;клиентом и&nbsp;аналитиком</div>
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/017-light bulb.svg">
                  </div>
                  <div class="steps__item">
                    ...
                    <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/analytics-b/042-data storage.svg">
                  </div>
                </div>
              ...
              <div class="wrapper">
                ...
                <div class="block-group block-group--3">
                  <div class="block-group__item panel panel--no-shadow">
                    ...
                    <img src="./dist/i/icons/analytics-b/032-data visualization.svg" alt="иллюстрация" class="panel__image">
                  </div>
                  <div class="block-group__item panel panel--black panel--no-shadow">
                    ...
                    <img src="./dist/i/icons/analytics-w/016-effective.svg" alt="иллюстрация" class="panel__image">
                  </div>
                  <a class="block-group__item panel panel--blue" href="./services.html#big-business">
                    <div class="panel__content">
                      ...
                      <img src="./dist/i/icons/analytics-b/025-structured data.svg" alt="иллюстрация" class="panel__image">
                    </div>
                  </a>
              </div>
            </section>
                ...
                <div class="accounting">
                  <a href="#" class="accounting__item panel panel--white">
                    <div class="panel__content">
                      ...
                      <img src="./dist/i/panel-zeta.svg" alt="zeta logo" class="panel__image panel__image--logo">
                    </div>
                  </a>
                  <a href="#" class="accounting__item panel panel--yellow">
                    <div class="panel__content">
                      ...
                      <img src="./dist/i/panel-1c.svg" alt="1c logo" class="panel__image panel__image--logo">
                    </div>
                  </a>
                </div>
              </div>
                ...
                <div class="swiper" data-swiper-id="cases">
                  <div class="cases js-cases swiper-wrapper">
                    <a href="./case.html" class="swiper-slide cases__item panel panel--decoration-yellow" data-case-category="yellow">
                      <div class="panel__head">
                        <img src="./dist/i/panel-1c.svg" alt="1c logo" class="case__image">
                      </div>
                    ...
                    <a href="./case.html" class="swiper-slide cases__item panel panel--decoration-blue" data-case-category="blue">
                      <div class="panel__head">
                      <img src="./dist/i/panel-zeta.svg" alt="zeta logo" class="case__image">
                      </div>
                      <div class="panel__content case">
                ...
                <div class="help">
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/039-research and development.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/046-profit.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/019-effort.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/005-analytics.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/009-concentrate.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                  <div class="help__item panel panel--white panel--no-shadow">
                    <div class="panel__content help">
                      ...
                      <img src="./dist/i/icons/business-b/038-agreement.svg" alt="иллюстрация" class="help__image panel__image">
                    </div>
                  </div>
                </div>
                <div class="contact-big">
                  <div class="contact-big__title">Оставьте заявку для&nbsp;бесплатной консультации с&nbsp;нашим специалистом</div>
                  <img src="./dist/i/panel-contact-big.svg" alt="иллюстрация" class="contact-big__image">
