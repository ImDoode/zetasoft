        ...
        <div class="wrapper">
          ...
          <div class="steps">
            <div class="steps__item">
              ...
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/037-data analysis.svg">
            </div>
            <div class="steps__item">
              ...
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/022-iteration.svg">
            </div>
            <div class="steps__item">
              ...
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/006-confirmation.svg">
            </div>
            <div class="steps__item">
              <div class="steps__item-number">4</div>
              <div class="steps__item-text">Формируем бюджет решения и&nbsp;передаём в&nbsp;разработку</div>
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/011-calculator.svg">
            </div>
            <div class="steps__item">
              <div class="steps__item-number">5</div>
              <div class="steps__item-text">Наши разработчики пишут профессиональный&nbsp;код</div>
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/031-statistics.svg">
            </div>
            <div class="steps__item">
              <div class="steps__item-number">6</div>
              <div class="steps__item-text">Внедряем результат совместно с&nbsp;клиентом и&nbsp;аналитиком</div>
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/017-light bulb.svg">
            </div>
            <div class="steps__item">
              ...
              <img class="steps__item-image" alt="step illustration" src="./dist/i/icons/042-data storage.svg">
            </div>
          </div>
        ...
        <div class="wrapper">
          ...
          <div class="block-group block-group--3">
            <div class="block-group__item panel panel--no-shadow">
              ...
              <img src="./dist/i/icons/032-data visualization.svg" alt="иллюстрация" class="panel__image">
            </div>
            <div class="block-group__item panel panel--black panel--no-shadow">
              ...
              <img src="./dist/i/icons/016-effective.svg" alt="иллюстрация" class="panel__image">
            </div>
            <a class="block-group__item panel panel--blue" href="./services.html#big-business">
              <div class="panel__content">
                ...
                <img src="./dist/i/icons/025-structured data.svg" alt="иллюстрация" class="panel__image">
              </div>
            </a>
        </div>
      </section>
          ...
          <div class="help">
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/039-research and development.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/046-profit.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/019-effort.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/005-analytics.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/009-concentrate2.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
            <div class="help__item panel panel--white panel--no-shadow">
              <div class="panel__content help">
                ...
                <img src="./dist/i/icons/038-agreement.svg" alt="иллюстрация" class="help__image panel__image">
              </div>
            </div>
          </div>
