          ...
          <div class="anchors anchors--service">
            <a href="#issues" class="anchors__item panel panel--yellow">
              <div class="panel__content">
                <img src="./dist/i/anchor-issue.svg" alt="" class="anchors__image">
            ...
            <a href="#projects" class="anchors__item panel panel--red">
              <div class="panel__content">
                <img src="./dist/i/anchor-project.svg" alt="" class="anchors__image">
                <div class="anchors__bottom">
            ...
            <a href="#big-business" class="anchors__item panel panel--blue">
              <div class="panel__content">
                <img src="./dist/i/anchor-bb.svg" alt="" class="anchors__image">
                <div class="anchors__bottom">
      ...
      <section class="section section--black section--two-cols">
        <div class="wrapper">
          <div class="section__col">
            ...
            <img class="section__image" src="./dist/i/section-report.svg" alt="illustration">
          </div>
          <div class="section__col">
            <div class="diffs">
          ...
          <div class="business-tips">
            <div class="business-tips__item panel panel--no-shadow panel--black">
              <div class="panel__content">
                ...
                <img src="./dist/i/panel-business-tip1.svg" alt="" class="panel__image hide-sm hide-md">
                <img src="./dist/i/panel-business-tip1m.svg" alt="" class="panel__image show-sm">
              </div>
            </div>
            <div class="business-tips__item panel panel--no-shadow">
              <div class="panel__content">
                ...
                <img src="./dist/i/panel-business-tip2.svg" alt="" class="panel__image">
              </div>
            </div>
            <div class="business-tips__item panel panel--no-shadow">
              <div class="panel__content">
                <div class="panel__text">выявим слабые места в&nbsp;бизнес-процессах, которые необходимо оптимизировать</div>
                <img src="./dist/i/panel-business-tip3.svg" alt="" class="panel__image">
              </div>
            </div>
            <div class="business-tips__item panel panel--no-shadow panel--blue">
              <div class="panel__content">
                ...
                <img src="./dist/i/panel-business-tip4.svg" alt="" class="panel__image">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="pricing">
            <a href="#" class="pricing__item panel panel--white panel--shadow-blue">
              <div class="panel__content">
                ...
                <div class="panel__link">Рассчитать проект<img src="./dist/i/panel-pricing1.svg" alt="" class="panel__image"></div>
              </div>
            </a>
            <a href="#" class="pricing__item panel panel--white panel--shadow-blue">
              <div class="panel__content">
                ...
                <div class="panel__link">Посмотреть прайс<img src="./dist/i/panel-pricing2.svg" alt="" class="panel__image"></div>
              </div>
            </a>
          </div>
        </div>
